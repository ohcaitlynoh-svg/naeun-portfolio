...
export const cases: HowIWorkCase[] = [
  {
    ...
    problem:
      "한국뿐 아니라 전 세계에 분산된 APM / DPM / Kubernetes / Cloud 모니터링 환경과 다양한 고객 요구를 하나의 Enterprise Observability 제품으로 구조화해야 했습니다.",
    context: [
      "대량으로 축적되는 VOC + 영업/기술지원 요구사항",
      "Enterprise 환경",
      "기존 제품 구조와 기술적 제약",
      "여러 개발 조직과 협업",
    ],
    action: [
      "대량 VOC와 요구사항을 반복성·제품 적합성·일정·기술 가능성 기준으로 구조화",
      "공통 사용자 흐름과 핵심 모니터링 시나리오 정의",
      "구현 가능한 MVP 범위와 우선순위 결정",
      "개발 전 실제 제품 수준의 기획안을 완성해 개발 기준으로 제공",
      "APM / DPM / Kubernetes / Cloud를 하나의 통합 경험으로 설계",
    ],
    result: [
      "6개월 MVP",
      "APM / DPM / Kubernetes / Cloud 4개 프로그램 GS 인증 획득",
      "LG전자·삼성전자·금융결제원·경찰청 등 Enterprise 프로젝트에 적용",
      "주요 프로젝트 기준 약 40억 원 매출 성과",
    ],
  ...
  },
  {
    ...
    problem:
      "정기배송 운영의 반복 업무가 수작업 중심이라, 고객이 늘어날수록 일정 관리 복잡도가 커지는 구조였습니다.",
    context: ["1인 사업자 · 소규모 운영 환경", "기획부터 출시·운영까지 단독 진행"],
    action: [
      "실제 운영 flow 분석",
      "예약 / 일정 / 제작 / 배송 / 사후관리 상태 구조화",
      "기능을 줄이는 대신 반복 운영 자체를 자동화 대상으로 재정의",
      "정기구독 상품과 운영 구조를 플랫폼으로 연결",
      "이후 건설사 대상 B2B 모델로 확장",
    ],
    result: [
